...
var welcome = {
  ...
  html: "<label for='worker_id'>Enter your Prolific Worker ID. Please make sure this is correct! </label><br><input type='text' id='worker_id' name='worker_id' required><br><br<p>During the task, please do not refresh your screen.</p><p>Pressing refresh will prevent you from completing the task.</p><br>",
