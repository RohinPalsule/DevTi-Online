...
var shortestpath_phase = {
  ...
  on_finish: function(data) {
    ...
    if ((data.key_press == 49 && data.stimulus_left == data.stimulus_correct)||(data.key_press == 50 && data.stimulus_middle == data.stimulus_correct)||(data.key_press == 51 && data.stimulus_right == data.stimulus_correct)) {
      data.accuracy = 1
      correctness.push(1)
    } else {
      data.accuracy = 0
